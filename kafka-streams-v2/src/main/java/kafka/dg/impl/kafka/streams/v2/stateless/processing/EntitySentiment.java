...
public class EntitySentiment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4312820049891521300L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EntitySentiment\",\"namespace\":\"kafka.dg.impl.kafka.streams.v2.stateless.processing\",\"fields\":[{\"name\":\"created_at\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"entity\",\"type\":\"string\"},{\"name\":\"text\",\"type\":\"string\"},{\"name\":\"sentiment_score\",\"type\":\"double\"},{\"name\":\"sentiment_magnitude\",\"type\":\"double\"},{\"name\":\"salience\",\"type\":\"double\"}]}");
   ...
   */
  public static kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder newBuilder() {
    return new kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder();
  }
   ...
   * @return A new EntitySentiment RecordBuilder
   */
  public static kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder newBuilder(kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder other) {
    if (other == null) {
      return new kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder();
    } else {
      return new kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder(other);
    }
  }
   ...
   * @return A new EntitySentiment RecordBuilder
   */
  public static kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder newBuilder(kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment other) {
    if (other == null) {
      return new kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder();
    } else {
      return new kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EntitySentiment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.created_at)) {
        this.created_at = data().deepCopy(fields()[0].schema(), other.created_at);
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder setEntity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder clearEntity() {
      entity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder setText(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder setSentimentScore(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder clearSentimentScore() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder setSentimentMagnitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder clearSentimentMagnitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder setSalience(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dg.impl.kafka.streams.v2.stateless.processing.EntitySentiment.Builder clearSalience() {
